...
- selection_params: 选择参数数据类
- score_comparator: 得分比较器
...
from dashboard.models.DFM.train.selection.selection_params import SelectionParams
from dashboard.models.DFM.train.selection.score_comparator import ScoreComparator
